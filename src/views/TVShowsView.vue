...
import { useGetDiscoverTVShowsQuery } from '@/queries/use-get-discover-tv-shows-query';

const { data, isLoading, hasNextPage, fetchNextPage, isFetchingNextPage } =
  useGetDiscoverTVShowsQuery();
</script>
<template>
  <section>
    <h2 class="text-3xl font-bold mb-8">Discover TV Shows</h2>
